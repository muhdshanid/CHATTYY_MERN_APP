    ...
    <div className=' my-2'>
        <div className='flex items-center justify-between w-full h-full gap-4'>
            <div className='w-12  h-12 py-1 flex items-center justify-center'>
                <img className='w-10 h-10 hover:w-11 hover:shadow-purple-200 hover:h-11 transition-all rounded-full shadow-xl' src={dummyProfile} alt="profile" />
            </div>
            <div className='flex '>
            <div className='rounded-full p-2 hover:bg-gray-100'>
                <AiOutlineLoading3Quarters className=' shadow-xl' size={27} color="purple"/>
            </div>
            <div  className='rounded-full p-2 hover:bg-gray-100'>
                <RiMessage2Fill size={27} color="purple"/>
            </div>
            <div className='rounded-full p-2 hover:bg-gray-100'>
                <IoMdMore size={27} color="purple"/>
            </div>
            </div>
        </div>
    </div>
