...
const Chats = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="p-2 items-center gap-2 shadow-xl rounded-lg flex">
        {!inputActive ? (
          <BiSearch size={27} className="transition-all " color="purple" />
        ) : (
          <HiOutlineArrowLeft
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between gap-4 h-18  p-2 shadow-xl rounded-xl">
          <div className="w-12  h-12 py-1 flex items-center justify-center">
            <img
              className="w-10 h-10 hover:w-11
               hover:shadow-purple-200 hover:h-11
          ...
          <div className="">
            <h6 className="font-semibold leading-8">My angel</h6>
            <p>shanideee......</p>
          </div>
          <div>
