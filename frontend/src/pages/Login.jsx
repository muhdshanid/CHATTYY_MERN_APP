            ...
            <div className='px-4 py-8  w-full text-center flex flex-col gap-2'>
                ...
                <div className='flex   my-8  justify-center'>
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        className='rounded-lg w-64 bg-gray-100 p-4 border-none outline-none' />
                        <button className='bg flex items-center justify-center hover:bg-purple-800 text-white rounded-lg p-2 mt-4'>
                        {
                          res?.isLoading ? 
                ...
                <div className='px-4'>
                    <h6 className='text-md font-semibold '>Don't have an account ?
                     <Link to={"/signup"} className='color hover:underline cursor-pointer'> Signup</Link></h6>
                </div>
            </div>
        </div>
    </div>
